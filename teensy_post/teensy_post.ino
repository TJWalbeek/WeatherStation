...
void setup() {
  ...
  //wifi.println(F("AT+CWJAP=\"Summit2\",\"CookieMonster8232\"")); // AT+CWJAP="Summit2","CookieMonster8232"
...
//   char message[mes.length()+1]; // set up a char with the right length
//   mes.toCharArray(message,mes.length()+1); // convert the string to char
